...
class SymbolicState:
    ...
    def create_sample(cls, ctx: z3.Context) -> "SymbolicState":
        ...
        # Add memory accesses
        state.memory_accesses.append(MemoryAccess.create(ctx, "addr1", "val1", True))
        state.memory_accesses.append(MemoryAccess.create(ctx, "addr2", "val2", False))
...
def main():
    parser = argparse.ArgumentParser(
        description="Export BLSSS state structure to a file"
    )
    parser.add_argument(
        "--format",
